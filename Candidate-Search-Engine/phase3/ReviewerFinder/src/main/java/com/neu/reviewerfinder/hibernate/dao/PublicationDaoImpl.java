...
/**
 * @author DJ
 * This is the Hibernate DAO Class for Publication
 * It flushes batches of Publication to the DB
 * Performs specific functions on the DB for retrieval
 */
public class PublicationDaoImpl implements PublicationDao{
	@Override
	public void createAndStorePublication(String publisher,String publicationKey, String volume,String detail,Boolean isJournal) {
