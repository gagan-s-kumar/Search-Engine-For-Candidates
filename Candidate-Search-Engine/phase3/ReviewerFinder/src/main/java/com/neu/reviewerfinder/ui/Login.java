...
public class Login extends Application {
	 ...
	 * @param primaryStage
	 */
	private void validateUser(String username, String password, final ProgressIndicator loadingIndicator, Stage primaryStage) {
	...
	public void start(Stage primaryStage) {
		...
		btnLogin.setOnAction(event -> validateUser(txtUserName.getText(), pf.getText(), loadingIndicator, primaryStage));
