...
import com.neu.reviewerfinder.hibernate.conf.*;
/**
 * @author DJ
 * This is the CommitteeData Parsing Class
 * The committee Info from the committees files
 * is extracted using these files.
 */
public class CommitteeParser {
	...
	/**
	 * This is the CommitteeParser Constructor
	 * It iterates through files of all years and
	 * Generates the Committee Table with fields-
	 * <Conference Name,Name,Year,G-Flag,P-Flag>
	 */
			...
			if (listOfFiles[i].isFile()) {
				...
				try {
					...
					while ((strLine = br.readLine()) != null)   {
						...
						committeeConf.setG_flag(G_flag);
						committeeConf.setP_flag(P_flag);
