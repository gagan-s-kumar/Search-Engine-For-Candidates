...
public class SearchResults extends Application {
	...
	/**
	 * This method displays the Search Results page 
	 * Each column is can be sorted by clicking on the column header
	 * @param primaryStage
	 */
	...
	public void start(Stage primaryStage) {
		...
		vbox.getChildren().addAll(hbt, hbt1, tableView);
	...
	/**
	 * This method gets the list of authors
	 * Returns the observable list of author details composed of
         * 1) Author name
         * 2) Conference Paper Count
         * 3) Journal Paper Count
	 * @return
	 */
