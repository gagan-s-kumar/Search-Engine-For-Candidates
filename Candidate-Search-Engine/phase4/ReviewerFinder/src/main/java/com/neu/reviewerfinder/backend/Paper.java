...
/**
 * @author DJ This is the Paper Wrapper Class All the inproceedings from the Dblp.xml file are
 *         extracted using the parser classes.
 */
public class Paper {
  ...
  public static int getElement(String name) {
    if (name.equals("inproceedings") || name.equals("article")) {
      ...
      return AUTHOR;
    } else if (name.equals("title") || name.equals("sub") || name.equals("sup") || name.equals("i")
        || name.equals("tt")) {
      return TITLE;
  ...
  /**
   * This is the Paper Constructor It initializes the tag name variables with default values.
   */
  public Paper() {
    key = "";
    title = "";
