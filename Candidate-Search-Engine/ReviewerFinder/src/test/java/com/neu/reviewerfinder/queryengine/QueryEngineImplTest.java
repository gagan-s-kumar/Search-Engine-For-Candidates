...
public class QueryEngineImplTest {
  ...
  public void testGetAuthorToStringFunction() {
    ...
    author.setAffiliation("Aarhus University");
    author.setCountry("europe");
    author.setDept("log");
    ...
    String authStr = String
        .format("ID: " + obj.getAuthorId() + " Name: " + author.getAuthorName() + " Paper Keys: "
            + String.join(", ", author.getPaperKeys()) + " Conference Papers Published: "
            + author.getConferencePaperCount() + " Journal Papers Published: "
            + author.getJournalPaperCount() + " Affiliation: " + author.getAffiliation()
            + " Country: " + author.getCountry() + " Department: " + author.getDept());
