...
/**
 * @author DJ This is the Article Parsing Class The Article Info from the Dblp.xml file are
...
public class Article {
  ...
  /**
   * This is the Article Constructor It initializes the tag name variables with default values.
   */
  public Article() {
    key = "";
    title = "";
