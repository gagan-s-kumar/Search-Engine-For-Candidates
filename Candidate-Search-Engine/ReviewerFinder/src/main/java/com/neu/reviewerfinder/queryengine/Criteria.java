...
public interface Criteria {
  ...
  /**
   * Returns the number of years for which author shouldn't be part of a committee
   * 
   * @return number
   */
  ...
  /**
   * Sets the number of years for which author shouldn't be part of a committee
   * 
